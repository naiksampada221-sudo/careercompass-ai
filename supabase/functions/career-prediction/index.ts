...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert career advisor and job market analyst. Given a list of skills, predict the most suitable job roles.
...
- salary_range should reflect current US market rates

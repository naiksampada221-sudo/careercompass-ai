                  ...
                  >
                    ...
                    {[...Array(12)].map((_, i) => (
                      <motion.div
                        ...
                        style={{
                          background: ["hsl(258, 90%, 62%)", "hsl(220, 70%, 55%)", "hsl(142, 76%, 46%)", "hsl(45, 93%, 58%)", "hsl(0, 84%, 60%)"][i % 5],
                          left: "50%",
                          top: "40%",
                        }}
                    ...
                    <motion.div
                      className="w-20 h-20 rounded-full bg-green-500/10 flex items-center justify-center mx-auto mb-4 relative"
                    ...
                    <motion.div
                      className="mt-4 h-1.5 bg-primary/20 rounded-full overflow-hidden mx-auto w-48"
                  ...
                  >
                    ...
                    {["✉️", "📬", "💌", "✨", "🔐", "📧"].map((emoji, i) => (
                      <motion.div
                        ...
                        animate={{
                          scale: [0, 1.2, 0.8],
                          x: Math.cos((i * 60 * Math.PI) / 180) * (70 + i * 10),
                          y: Math.sin((i * 60 * Math.PI) / 180) * (50 + i * 10),
                          opacity: [0, 1, 0.6],
                        }}
                    ...
                    {/* Big animated envelope icon */}
                    <motion.div
                      className="w-24 h-24 rounded-3xl bg-primary/10 flex items-center justify-center mx-auto mb-5 relative"
                    ...
                    >
                      <motion.div
                        ...
                        style={{ background: "linear-gradient(135deg, transparent, hsla(258, 90%, 62%, 0.2), transparent)" }}
                    ...
                    <motion.p
                      ...
                      transition={{ delay: 0.6 }}
                    >
                      We've sent a <span className="text-primary font-semibold">6-digit verification code</span> to
                    </motion.p>
                    <motion.p
                      className="text-sm font-bold text-foreground mb-5 flex items-center justify-center gap-2"
                    ...
                    <motion.a
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-border bg-background/80 hover:bg-accent text-sm font-medium transition-all relative overflow-hidden group"
                      initial={{ opacity: 0, y: 10 }}
                      animate={{ opacity: 1, y: 0 }}
                    ...
                    <motion.button
                      ...
                      className="block mx-auto mt-4 text-xs text-primary hover:underline font-medium"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      transition={{ delay: 1.2 }}
                    >
                      I have the code → Enter now
                    </motion.button>
                  </motion.div>
                ) : (
                  /* ───── OTP INPUT SCREEN ───── */
                  ...
                  >
                      ...
                      <div className="relative w-24 h-24">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <motion.div
                            ...
                            animate={otpTimer <= 30 ? { scale: [1, 1.08, 1] } : {}}
                        ...
                        <motion.div
                          ...
                          style={{ boxShadow: "0 0 20px hsla(258, 90%, 62%, 0.15)" }}
                      ...
                      {otpCode.map((digit, index) => (
                        <motion.div key={index} className="relative">
                          <motion.input
                            ...
                            whileFocus={{ scale: 1.1, borderColor: "hsl(258, 90%, 62%)" }}
                          />
                    ...
                    <div className="flex justify-center gap-1">
                      {otpCode.map((digit, i) => (
                        <motion.div
                          key={i}
                          className={`h-1 rounded-full transition-all duration-300 ${digit ? "w-6 bg-primary" : "w-3 bg-muted"}`}
                          layout
                        />
                      ))}
                    </div>
                    ...
                    <motion.button
                      ...
                      className="w-full gradient-btn py-3.5 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-50 relative overflow-hidden group"
                    ...
                    >
                      ...
                      <span className="relative z-10 flex items-center gap-2">
                        {otpVerifying ? (
                          ...
                          <motion.span
                            animate={otpCode.join("").length === 6 ? { rotate: [0, 10, -10, 0] } : {}}
                    ...
                    <div className="flex flex-col items-center gap-2 text-sm">
                      <motion.button
                        ...
                        className="flex items-center gap-1.5 text-primary font-medium hover:underline disabled:opacity-40 disabled:cursor-not-allowed transition-all"
